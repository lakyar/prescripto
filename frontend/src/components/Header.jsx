  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vh] md:mb-[-30px]'>
            <p className='font-display text-3xl md:text-4xl lg:text-5xl text-white font-semibold leading-tight'>
        ...
        <div className='md:w-1/2 relative'>
            <img className='w-full max-h-full md:absolute bottom-0 h-auto rounded-lg' src={assets.header_img} alt="" />
        </div>
    </div>
  )
}
